...
import jp.techacademy.shingo.fuse.apiapp.FavoriteShop.Companion.getDeletedShops
 ...
 */
class ApiAdapter : ListAdapter<Shop, ApiItemViewHolder>(ApiItemViewHolder.ApiItemCallback()) {
